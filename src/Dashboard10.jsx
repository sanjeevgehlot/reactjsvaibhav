                  ...
                  <div className="table-area">
                     ...
                     <div className="table-responsive table_content">
                        <table className="table table-striped">
                           <thead>
                              <tr>
                                 <th className="color-grey-dark">Order No.</th>
                                 <th className="color-grey-dark">Product Name</th>
                                 <th className="color-grey-dark">Driver Name</th>
                                 <th className="color-grey-dark">Status</th>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>Skating Shoes</td>
                                 <td>Jonny Doe</td>
                                 <td><span className="btn-status btn_green">Delivered</span></td>
                              ...
                              <tr>
                                 ...
                                 <td>Skating Shoes</td>
                                 <td>Jonny Doe</td>
                                 <td><span className="btn-status btn_red">Delivered</span></td>
                                 <td><span className="action_part">Action</span></td>
                              </tr>
                              <tr>
                                 <td>65789801</td>
                                 <td>Skating Shoes</td>
                                 <td>Jonny Doe</td>
                                 <td><span className="btn-status btn_yellow">Delivered</span></td>
                                 <td><span className="action_part">Action</span></td>
                              </tr>
                              <tr>
                                 <td>65789801</td>
