         ...
         <div className="col-md-3 col-lg-3 col-xl-3">
            <div className="left_sidebar">
               <ul className="sidebar_menu no_ul">
                  ...
                  <li>
                     <a onClick={() => setShow(true)} href="dashboard12" className="active f16 d-flex justify-content-between color_black">
                        <span>Driver</span>
                        <span>
                           <svg xmlns="http://www.w3.org/2000/svg" width="11.747" height="11.747"
                              viewBox="0 0 11.747 11.747">
                  ...
                  <li>
                     <a href="dashboard10" className="f16 d-flex justify-content-between color_black">
                        <span>Orders</span>
                        <span>
                           <svg xmlns="http://www.w3.org/2000/svg" width="11.747" height="11.747"
                              viewBox="0 0 11.747 11.747">
